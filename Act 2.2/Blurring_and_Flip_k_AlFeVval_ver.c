...
void BMP_gray(BMP_Image *img)
{
  ...
  printf("Imagen en grises generada en un tiempo total de (%lf)\n", (endTime - startTime));
}
...
void BMP_horFlip(BMP_Image *img){
  ...
  free(output);
  const double endTime = omp_get_wtime();
  printf("Imagen rotada horizontalmente generada en un tiempo total de (%lf)\n", (endTime - startTime));
}
...
int main(){
  //BMP_Image * img = BMP_open("gtr35-HD.bmp");
  ...
  #pragma omp sections
  {
    ...
    #pragma omp section
    BMP_blur("GrayScale.bmp",87);
    #pragma omp section
    BMP_blur("GrayScale.bmp",89);
    #pragma omp section
    BMP_blur("GrayScale.bmp",99);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",1);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",13);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",25);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",37);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",49);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",51);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",63);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",75);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",87);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",89);
    #pragma omp section
    BMP_blur("HorizontalRot.bmp",99);
  }
